...
namespace cs251
{
 ...
 struct sim_t
  ...
  //Common Body Defs
  extern b2Body* bsensor;
  extern b2Body* insphere;
  extern b2Body* cannonbutton;
  extern b2Body* stopbutton;
  extern b2Body* mazesphere;
  extern b2Body* rplatform;
  extern b2Body* cannonball1;
  extern b2Body* cannonball2;
  extern b2Body* cannonball3;
  extern b2Body* car2;
}
