...
void b2World::DrawJoint(b2Joint* joint)
{
	...
	b2Color color(1.0f, 0.0f, 0.0f, 1.0f);

	switch (joint->GetType())
	{
	case e_distanceJoint:
		{
			b2Color color1(1.0f, 1.0f, 0.0f, 1.0f);
	...
	case e_pulleyJoint:
		{
			b2Color color1(0.0f, 0.0f, 1.0f, 1.0f);
			b2PulleyJoint* pulley = (b2PulleyJoint*)joint;
			b2Vec2 s1 = pulley->GetGroundAnchorA();
			b2Vec2 s2 = pulley->GetGroundAnchorB();
			m_debugDraw->DrawSegment(s1, p1, color1);
			m_debugDraw->DrawSegment(s2, p2, color1);
			m_debugDraw->DrawSegment(s1, s2, color1);
		}
		break;
	...
	/*case e_revoluteJoint:
		{
			b2Color color1(1.0f, 0.0f, 0.0f, 1.0f);
