...
namespace cs251
{
  ...
  dominos_t1::dominos_t1()
  {
    ...
    
    {
      ...
      (b1->CreateFixture(&shape, 0.0f))->zsetcol(124,255,0,0.8);
    }
        
    //Top horizontal shelf
    {
      b2PolygonShape shape;
      shape.SetAsBox(6.0f, 0.3f);
	    b2BodyDef bd;
      bd.position.Set(-31.0f, 30.0f);
      b2Body* ground = m_world->CreateBody(&bd);
      (ground->CreateFixture(&shape, 0.0f))->zsetcol(0,0,255,0.9);
    }
	...
	b2BodyDef bd;
	bd.position.Set(-37.0f, 28.0f);
	b2 = m_world->CreateBody(&bd);
	(b2->CreateFixture(&shape, 10.0f))->zsetcol(0,0,255,0.9);
      }
	...
	(b4->CreateFixture(&shape, 2.0f))->zsetcol(0,0,127,0.9);
      }
    ...
    //The train of small spheres
    {
      ...
      for (int i = 0; i < 10; ++i)
        ...
        spherebody->setmj();
    	  (spherebody->CreateFixture(&ballfd))->zsetcol(rand()%256,rand()%256,rand()%256,0.8);
    	}
    }
    ...
    //The pulley system
    {
      ...
      (box1->CreateFixture(fd1))->zsetcol(0,100,0,0.8);
      (box1->CreateFixture(fd2))->zsetcol(0,100,0,0.8);
      (box1->CreateFixture(fd3))->zsetcol(0,100,0,0.8);

      //The bar
      bd->position.Set(10,15);	
      fd1->density = 34.0;	  
      b2Body* box2 = m_world->CreateBody(bd);
      (box2->CreateFixture(fd1))->zsetcol(128,0,0,0.8);
